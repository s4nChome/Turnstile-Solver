...
def parse_args():
    ...
    parser.add_argument('--thread', type=int, default=5, help='Set the number of browser threads to use for multi-threaded mode. Increasing this will speed up execution but requires more resources (default: 1)')
